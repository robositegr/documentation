...
<AccordionGroup>
  ...
  <Accordion title="Webhook URL" icon="link">
    ...
    **Example:** `https://automate.Robosite.gr/api/v1/webhooks/your-webhook-id`
...
```json
{
  ...
  "transcript": [
    {
      "text": "Hello! This is Sarah from robosite.",
      "type": "transcript",
      "sender": "bot",
  ...
  "formatted_transcript": "AI: Hello! This is Sarah from robosite.\\nCustomer: Hi, I'm doing well, thanks.",
  "recording_url": "https://app.Robosite.gr/storage/recordings/call-12345.mp4",

...
title: "Cost Overview"
icon: "dollar-sign"
description: "Understand the main components of Robosite.gr pricing, including call minutes, number rentals, and optional fees"
---

Robosite.gr uses a **credit/minute system** to track usage for both AI processing and carrier network fees. Here's how it breaks down:
...
2. **Acquire or Verify a Number**: Rent from Robosite.gr or add your own as caller ID for outbound.

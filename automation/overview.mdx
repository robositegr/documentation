...
description: "Learn about Robosite.gr's built-in automation engine for creating workflows without coding"
---
...
Robosite.gr includes an internal automation engine (similar to Zapier or Make) that lets you build flows—no coding required. For instance:
...
- **Triggers**: Events inside Robosite.gr (e.g., "call ended," "inbound call context injection").

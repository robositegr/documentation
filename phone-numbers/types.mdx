...
icon: "phone"
description: "Learn about the different types of phone numbers you can use with Robosite.gr: dedicated numbers, SIP integration, and Caller ID"
---

Robosite.gr lets you connect three different kinds of phone numbers to your AI assistant:

1. **Normal (Dedicated) Numbers**

   - Rented directly from Robosite.gr.
...
2. **SIP Integration (VOIP/PBX)**
   ...
   - This setup allows you to keep your existing numbers while benefiting from Robosite.gr's AI.

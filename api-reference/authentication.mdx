...
The robosite API uses API keys to authenticate requests. You need to include your API key in the header of each request you make to the API.

## Obtaining an API Key

To obtain an API key:

1. Log in to your robosite account at [https://app.robosite.gr](https://app.robosite.gr)
...
```bash
curl -X GET "https://api.robosite.gr/api/user/campaigns" \
